...
Create the index on the elasticsearch server.
...
Drops the index from the elasticsearch server. Calling C<create_index>
or C<update_index> after this will recreate it again.
